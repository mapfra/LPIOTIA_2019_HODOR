...
<body class="login_page">
    <div class="login-wrapper">
        <div id="login" class="login loginpage offset-xl-4 col-xl-4 offset-lg-3 col-lg-6 offset-md-3 col-md-6 col-offset-0 col-12">
            <a href="/AppMobile/login.php"><img class="rounded mx-auto d-block" src="/AppMobile/img/logo_hodor.JPG"></a>
            ...
            <p class="submit text-center">
                ...
                <a href="reset-password.php" class="btn btn-primary">Réinitialiser votre mot de passe</a>
            </p>
            <p class="submit text-center"> 
