...
<head>
    ...
    <link href="/AppMobile/css/style.css" rel="stylesheet" type="text/css" media="screen"/>
    <link href="/AppMobile/css/style_paris.css" rel="stylesheet" type="text/css" media="screen"/>
...
<body class="login_page">
    <div class="login-wrapper">
        <div id="login" class="login loginpage offset-xl-4 col-xl-4 offset-lg-3 col-lg-6 offset-md-3 col-md-6 col-offset-0 col-12">
            ...
            <img class="rounded mx-auto d-block img-fluid" alt="Responsive image" src="/AppMobile/img/door_fanart.jpg">
...
<!--                     <h1 class="text-center text-bleu-enedis">H.O.D.O.R.</h1>
                    <br> -->
                    <h2 class="text-center"><span class="text-bleu-enedis">H</span><span class="text-bleu-enedis">O</span class="text-bleu-enedis">ld The <span class="text-bleu-enedis">D</span><span class="text-bleu-enedis">O</span>o<span class="text-bleu-enedis">R</span></h2>
<!--                 </p>
                <p>
                </p> -->
