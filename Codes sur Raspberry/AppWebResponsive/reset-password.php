...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["new_password"]))){
        $new_password_err = "Entrer votre nouveau mot de passe.";     
    } elseif(strlen(trim($_POST["new_password"])) < 6){
        $new_password_err = "Votre mot de passe doit faire au moins 6 caractères.";
    } else{
...
<head>
    ...
    <meta charset="utf-8" />
    <title>HODOR - Reset mot de passe</title>
...
<body>
    <div class="wrapper">
        ...
        <p>Compléter ce champ pour réinitialiser ce mot de passe.</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"> 
            ...
            <div class="form-group">
                ...
                <a class="btn btn-link" href="control_panel.php">Cancel</a>
            </div>
        </form>
    </div>    
</body>
